...
if(!isset($_SESSION['user'])){
    ...
    exit; // Tambahkan exit agar kode di bawah tidak diproses jika belum login
}
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="container-fluid">
                    <?php
                        ...
                        if (file_exists($page . '.php')) {
                            ...
                            // Tampilan jika file halaman tidak ditemukan (Default Dashboard)
